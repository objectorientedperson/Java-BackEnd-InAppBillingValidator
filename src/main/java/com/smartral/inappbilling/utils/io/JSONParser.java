 ...
 * a {@link Map} object containing the object fields mapped to their values. If the value is
 * a nested object a nested {@link Map}/{@link java.util.List} is returned. </p>
 * 
 * <p>
                        ...
                        case '\\':
                            ...
                            if (c == 'u') {
                                ...
                                try {
                                    ...
                                    err.printStackTrace();
                                    Logger.getLogger(JSONParser.class.getSimpleName()).log(Level.INFO, "Error in parsing \\u" + unicode);
                                }
                            } else {
                                switch(c) {
                                    case 'n':
